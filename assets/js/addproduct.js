...
let productPersonalizeOption = document.querySelectorAll('input[type="checkbox"]');
...
addOptionBtn.addEventListener('click', function(e) {
    ...
    while (continueChoice) {
        ...
        if (!choice) return;
        let optionPrice = prompt('Prix de l\'option sous la forme 0.00€ :');
        if (!optionPrice) optionPrice = 0;
        choices.push({
            name: choice,
            price: optionPrice.replace(',', '.')
